                    ...
                    <div className="sticky top-24 space-y-6">
                        <div className="rounded-lg border border-slate-800 bg-slate-900/50 p-6">
                            ...
                            <ul className="space-y-3">
                                <li>
                                    <a href="https://drive.google.com/file/d/1uVejcKDG4WUNJGrGkzXouq8k6PFMidwo/view?usp=sharing" className="flex items-center gap-2 text-sm text-amber-500 hover:text-amber-400 hover:underline">
